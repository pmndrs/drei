import { ShaderChunk, MeshDepthMaterial, MeshDistanceMaterial, RGBADepthPacking, UniformsUtils, MathUtils } from 'three'
...
export function createDerivedMaterial(baseMaterial, options) {
  ...
  const derive = function (base) {
    ...
    derived.uniforms = Object.assign({}, base.uniforms, options.uniforms)
    derived.defines = Object.assign({}, base.defines, options.defines)
    derived.defines[`TROIKA_DERIVED_MATERIAL_${optionsKey}`] = '' //force a program change from the base material
    derived.extensions = Object.assign({}, base.extensions, options.extensions)
...
function upgradeShaders({ vertexShader, fragmentShader }, options, key) {
  ...
  if (customRewriter) {
    const res = customRewriter({ vertexShader, fragmentShader })
