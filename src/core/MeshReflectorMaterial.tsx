...
// TODO: merge into MeshReflectorMaterialProps
type MeshReflectorMaterialComponentProps = Omit<ThreeElements['meshStandardMaterial'], 'ref'> & {
  resolution?: number
  mixBlur?: number
  mixStrength?: number
...
declare module '@react-three/fiber' {
  interface ThreeElements {
    meshReflectorMaterialImpl: MeshReflectorMaterialProps & { ref?: ThreeElements['meshStandardMaterial']['ref'] }
  }
}

export const MeshReflectorMaterial: ForwardRefComponent<
  MeshReflectorMaterialComponentProps,
  MeshReflectorMaterialImpl
> = /* @__PURE__ */ React.forwardRef<MeshReflectorMaterialImpl, MeshReflectorMaterialComponentProps>(
  (
    {
      mixBlur = 0,
      mixStrength = 1,
