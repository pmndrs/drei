...
export type MaskProps = Omit<JSX.IntrinsicElements['mesh'], 'children'> & {
...
export function Mask({ id = 1, children, colorWrite = false, depthWrite = false, ...props }: MaskProps) {
