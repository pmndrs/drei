...
export type CloneProps = Omit<JSX.IntrinsicElements['group'], 'children'> & {
...
export const Clone = React.forwardRef<THREE.Group, CloneProps>(
  ({ object, children, deep, castShadow, receiveShadow, inject, keys, ...props }, forwardRef) => {
