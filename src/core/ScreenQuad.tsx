...
export type ScreenQuadProps = Omit<JSX.IntrinsicElements['mesh'], 'args'>

export const ScreenQuad = React.forwardRef<THREE.Mesh, ScreenQuadProps>(function ScreenQuad(
  { children, ...restProps },
  ref
) {
