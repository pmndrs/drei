...
function main() {
  console.log('🔍 Parsing exports from dist/webgpu/index.d.ts...')
  ...
  if (missingExclusions.length > 0) {
    console.log(`\n⚠️  Warning: These exclusions don't match any exports:`)
